...
encryption_key = str.maketrans(original_alphabet, encrypted_alphabet)
decryption_key = str.maketrans(encrypted_alphabet, original_alphabet)

print(original_text.translate(encryption_key))
print(encrypted_text.translate(decryption_key))